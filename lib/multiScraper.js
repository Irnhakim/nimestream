...
export async function getEpisodeFromSource(sourceKey, episodeSlug) {
  ...
  const prevHref = $('.npage .prev a, .npv .prev a, .npvprev a, .naveko .prev a, .navigation-links .prev a').first().attr('href') || 
                   $('.npage a:contains("Prev"), .npage a:contains("Sebelumnya")').first().attr('href') || '';
                   
  const nextHref = $('.npage .next a, .npv .next a, .npvnext a, .naveko .next a, .navigation-links .next a').first().attr('href') || 
                   $('.npage a:contains("Next"), .npage a:contains("Selanjutnya")').first().attr('href') || '';
                   
  const animeHref = $('.npage .all a, .npv .all a, .npage a.all, .naveko .all a, .naveko .back a, .navigation-links .all a, .npage a:contains("Series"), .npage a:contains("All")').first().attr('href') || '';
